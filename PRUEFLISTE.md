...
| Beiwerk mit Klartext an Katalog, Seite, Objekt und Signaturfeld (`/Perms`, `/DSS`, `/PageLabels`, `/Threads`, `/Collection`, `/OutputIntents`, `/URI`, `/DPartRoot`, `/VP`, `/PresSteps`, `/Ref`, `/OPI`, `/SV`, `/Lock`); `/PageLabels` nach einem direkten Wert und in der Tiefe; jeder Schlüssel an Katalog, Seitenbaum und Seite außerhalb der Erlaubnisliste (`/SpiderInfo`, `/Legal`, `/Requirements`), Seiten-`/OutputIntents`, `/3DU` | A | Spur-A-Runde 1 (#70), Spur-A-Runde 2 (#92) | `crates/redact-pdf/tests/zo_b_traeger.rs`, `crates/redact-pdf/tests/zp_b_seitenbeschriftung.rs`, `crates/redact-pdf/tests/zp_b_erlaubte_schluessel.rs` |
